...
export default function LandingPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (email) {
      // Hier würde man z.B. Firebase, Supabase oder Mailchimp API benutzen
      console.log('E-Mail für Beta-Test vorgemerkt!', email);
      setSubmitted(true);
    }
  };
    ...
    <div className="font-sans bg-gray-900 text-gray-100">
      ...
      <header className="bg-gradient-to-br from-purple-700 to-indigo-800 text-center py-20 px-6">
        ...
        <div className="flex justify-center">
          <a
            href="#anmeldung"
            className="bg-indigo-500 hover:bg-indigo-600 transition px-6 py-3 rounded-2xl text-white font-semibold shadow-lg"
          >
            Jetzt vormerken
          </a>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="bg-gray-800 p-6 rounded-2xl shadow-xl">
            <h3 className="font-bold text-xl mb-4 text-purple-400">
              Die Probleme klassischer Lernmethoden:
            </h3>
      ...
      <section
        id="anmeldung"
        className="bg-gradient-to-br from-indigo-800 to-purple-800 py-20 px-6 text-center"
      >
        <h2 className="text-3xl font-bold mb-4">
          Jetzt dabei sein! 
        </h2>
        <p className="mb-6 text-lg">
          Werde Beta-Testerin: Trage dich hier ein und gehöre zu den ersten Nutzer:innen! 
        </p>

        {submitted ? (
          <p className="text-green-500 font-semibold">
            Vielen Dank! Deine E-Mail wurde vorgemerkt.
          </p>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row justify-center items-center gap-4 max-w-xl mx-auto">
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-600 bg-gray-900 text-gray-100"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
            />
            <button
              type="submit"
              className="bg-green-500 hover:bg-green-600 transition px-6 py-3 rounded-xl text-gray-100 font-semibold shadow-lg"
            >
              Jetzt vormerken
            </button>
          </form>
      ...
      <footer className="text-center text-sm py-8 bg-gray-950 text-gray-400">
        ...
        <div className="space-x-4">
          ...
          <a
            href="https://www.linkedin.com/company/shoshin-artoflife/"
            target="_blank"
